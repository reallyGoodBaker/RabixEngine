...
export declare class Matrix extends Float64Array {
    ...
    set e(v: number);
    set f(v: number);
    static from(init: Iterable<number>, mapfn?: (v: number, k: number) => number, thisArg?: any): Matrix;
    clone(): Matrix;
    setIdentity(): this;
    ...
    transpose(): Matrix;
    static multiply(mat1: Matrix, t: Matrix | Vector4): Vec4 | Matrix;
    multiply(t: Matrix | Vector4): Vec4 | Matrix;
    valueOf(): Float64Array;
    toString(): string;
    static perspective(fov: number, aspect: number, near: number, far: number): Matrix;
    static orthographic(right: number, top: number, near: number, far: number): Matrix;
